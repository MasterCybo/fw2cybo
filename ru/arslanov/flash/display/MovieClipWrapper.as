package ru.arslanov.flash.display {
	 ...
	 */
	public class MovieClipWrapper extends ASprite {
		...
		static public function createFromClass( className:Class, autoPlay:Boolean = true, reversed:Boolean = false ):MovieClipWrapper {
			return new MovieClipWrapper( new className(), autoPlay );
		}
		...
		Constructor
		***************************************************************************/
		public function MovieClipWrapper( mc:MovieClip, autoPlay:Boolean = true, reversed:Boolean = false ) {
			mc.stop();
